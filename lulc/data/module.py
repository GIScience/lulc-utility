...
class AreaDataModule(LightningDataModule):
    def __init__(self, dataset: AreaDataset,
        ...
        self.loader_p = partial(DataLoader, batch_size=batch_size,
                                pin_memory=True,
                                num_workers=num_workers,
                                persistent_workers=True)

    def train_dataloader(self) -> DataLoader:
        return self.loader_p(dataset=self.train_dataset, shuffle=True, collate_fn=random_crop_collate_fn(self.crop_height, self.crop_width))

    def val_dataloader(self) -> DataLoader:
        return self.loader_p(dataset=self.val_dataset, collate_fn=center_crop_collate_fn(self.crop_height, self.crop_width))

    def test_dataloader(self) -> DataLoader:
        return self.loader_p(dataset=self.test_dataset, collate_fn=center_crop_collate_fn(self.crop_height, self.crop_width))
